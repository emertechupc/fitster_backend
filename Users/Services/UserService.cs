...
using Fitster.API.Security.Exceptions;
...
namespace Fitster.API.Users.Services;
...
public class UserService : IUserService
{
    ...
    public async Task<AuthenticateResponse> Authenticate(AuthenticateRequest request)
    {
        ...
        // Perform validation
        if (user == null || !BCryptNet.Verify(request.Password, user.PasswordToken))
        {
    ...
    public async Task RegisterAsync(RegisterRequest request)
    {
        ...
        // Hash password
        user.PasswordToken = BCryptNet.HashPassword(request.Password);
